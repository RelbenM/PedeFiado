...
// Insert a new data to the database
  Future<void> addItem() async {
    await DatabaseHelper.createItem(
        _firstnameController.text, _lastnameController.text, _phoneController.text, _addressController.text);
    _refreshData();
  }
  ...
  Future<void> updateItem(int id) async {
    await DatabaseHelper.updateItem(
        id,_firstnameController.text, _lastnameController.text, _phoneController.text, _addressController.text);
    _refreshData();
  }
